...
<body class="bg-white text-gray-900">
      ...
      <div class="relative flex h-16 items-center justify-between">
        <div class="flex shrink-0 items-center space-x-4">
          <div class="flex items-center" href="/">
            <img class="block h-8 w-auto cursor-pointer" decoding="async" height="35" loading="lazy" src="{{ asset('img/logo_campnova_blue.svg') }}" width="35"/>
          </div>
        ...
        <div class="flex items-center ml-auto mr-4 space-x-2 sm:space-x-1">
          <a class="rounded-md border border-gray-300 px-3 py-1.5 text-xs font-medium text-gray-700 hover:bg-gray-100" href="/login">
            Masuk
          </a>
          <a class="rounded-md bg-[#5daac7] hover:bg-[#4b8fae] text-white px-3 py-1.5 text-xs font-medium focus:outline-none" href="/register">
            Daftar
          </a>
        </div>
        <div class="flex items-center sm:hidden">
          <button aria-expanded="false" aria-label="Open main menu" class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 focus:outline-none" id="mobile-menu-button" type="button">
          </button>
        </div>
      </div>
    </div>
  ...
  <main class="relative overflow-hidden bg-white px-4 py-6 sm:px-6 sm:py-20 lg:py-24">
    <div aria-hidden="true" class="absolute inset-0 overflow-hidden">
      <svg class="absolute left-0 top-0 h-full w-full opacity-5" height="100%" width="100%" xmlns="http://www.w3.org/2000/svg">
        <defs>
    ...
    <div class="container relative mx-auto max-w-screen-xl">
      <div class="flex min-h-[calc(100vh-64px)] flex-col items-center justify-center gap-8 md:min-h-0 md:flex-row md:items-center md:gap-8 lg:gap-16">
        <div class="w-full md:order-2 md:w-5/12 md:max-w-md lg:w-1/2">
          <div class="relative mx-auto overflow-hidden rounded-2xl md:aspect-auto">
            <div class="relative overflow-hidden">
              <lottie-player
                src="{{ asset('animations/cat-playing.json') }}"
        ...
        <div class="w-full md:order-1 md:w-7/12 lg:w-1/2">
          <div class="mx-auto max-w-lg md:mx-0">
            <h1 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl md:text-5xl lg:text-6xl">
              ...
              <span class="whitespace-nowrap">
                ...
                <span class="relative text-[#5daac7]">
                  Campnova
                  <svg aria-hidden="true" class="absolute left-0 top-full mt-1 h-[0.4em] w-full fill-[#5daac7]" preserveAspectRatio="none" viewBox="0 0 418 42">
            ...
            <div class="mt-6 flex flex-col gap-4 sm:flex-row md:mt-10 md:gap-6">
              <a aria-label="Register for a new account" class="flex w-full items-center justify-center rounded-xl bg-[#5daac7] hover:bg-[#4b8fae] px-5 py-3.5 text-base font-semibold text-white shadow-sm transition-all duration-300 hover:shadow-md focus:outline-none sm:w-auto md:px-8 md:py-5 md:text-lg" href="/register" role="button">
                Mulai Try Out
              </a>
              <a aria-label="Login to your account" class="flex w-full items-center justify-center rounded-xl border-2 border-[#5daac7] bg-white px-5 py-3.5 text-base font-semibold text-[#5daac7] transition-all duration-300 hover:bg-[#F2FAFD] focus:outline-none sm:w-auto md:px-8 md:py-5 md:text-lg" href="/login" role="button">
                Sudah Punya Akun
              </a>
            </div>
          </div>
