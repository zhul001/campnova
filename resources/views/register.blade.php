...
<body class="min-h-screen flex flex-col items-center p-4">
    <div class="relative w-full flex flex-col items-center overflow-visible">
        ...
        <div class="animation-container animation-left">
            <lottie-player src="/animations/cute-bird.json" background="transparent" speed="1"
                class="w-24 h-24 sm:w-32 sm:h-32" loop autoplay>
            </lottie-player>
        </div>
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        <div class="w-1/3">
                            ...
                            <p id="yearError" class="year-error">Tahun harus antara 1900 dan 2024</p>
                        </div>
    ...
    <script>
        ...
        birthYearInput.addEventListener('blur', validateYear);
